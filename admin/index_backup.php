...
<script type="text/javascript">
  function myNewFunction(sel) {
    ...
    var data = {
      labels: ["ASLI", "RATING BAIK", "RATING NORMAL", "PALSU"],
      datasets: [
      {
  ...
  var data = {
    ...
    datasets: [
    {
      ...
      $cek2 = mysqli_num_rows($rating_baik); echo $cek2;?>,<?php $rating_normal = mysqli_query($koneksi,"SELECT * FROM data_toko where status='Rating Normal'");
      $cek3 = mysqli_num_rows($rating_normal); echo $cek3;?>,<?php $palsu = mysqli_query($koneksi,"SELECT * FROM data_toko where status='Palsu'");
